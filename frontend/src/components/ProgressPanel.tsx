    ...
    return (
      <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 shadow-sm">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="font-semibold text-slate-700 dark:text-slate-200">Progress Tracker</h3>
          ...
          <button
            ...
            className="bg-slate-800 dark:bg-slate-200 text-white dark:text-slate-900 text-sm px-4 py-2 rounded-xl hover:bg-slate-700 dark:hover:bg-slate-300 transition-colors"
          >
            Check Progress
          </button>
        </div>
      ...
      <div className="divide-y divide-slate-50 dark:divide-slate-700/40">
        {summary.topic_results.map((tr) => (
          <div key={tr.topic} className="flex items-center gap-4 px-6 py-3">
            ...
            {/* Topic name */}
            <span className="flex-1 text-sm text-slate-700 dark:text-slate-200">{tr.topic}</span>
            ...
            <div className="flex items-center gap-2 shrink-0">
              ...
              {tr.is_weak && (
                <span className="text-xs bg-red-50 dark:bg-red-950/40 text-red-500 px-2 py-0.5 rounded-full font-medium">
                  Weak
                </span>
              )}
            </div>
